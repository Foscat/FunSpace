...
import GifFinder from './components/pages/GifFinder';
                ...
                <Router>
                    <div>
                        <Switch>
                            ...
                            <Route exact path="/gifFinder" render={() => <GifFinder loggedIn={this.state.loggedIn} />} />
                            <Route exact path="/events" render={() => <Events loggedIn={this.state.loggedIn} />} />
